...
public class Header extends JPanel {
    ...
    private final AudioButtonWrapper menuBtnWrapper;
    ...
    public Header() {
        ...
        menuBtnWrapper = new AudioButtonWrapper("", new SVGIconUIColor("menu.svg", 0.75f, "foreground.primary"), () -> Navigator.navigate(PageGameMenu.class));
        ...
        add(menuBtnWrapper.getButton(), "gapleft 32px");
    }
